...
print("The monster combat strength is now " +# Import the random library to use for the dice later
import random 
...
stars = "*" * num_stars
print("Hero gets <" + stars + "> stars") str(m_combat_strength) + " using the " + power_roll + " magic power.")
